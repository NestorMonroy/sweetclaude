...
# SweetClaude Small-Story Evidence Hook (Track C TASK-C3)
...
active = _active_small_story_workflow(project.expanduser().resolve(strict=False))
if active is None:
    sys.exit(0)
