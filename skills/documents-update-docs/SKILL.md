...
description: "Update documentation when implementation changes behavior."
---


!`bash ${CLAUDE_SKILL_DIR}/../../scripts/record-event.sh skill_invoked "skill=sweetclaude:documents-update-docs"`
