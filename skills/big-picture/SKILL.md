...
!`bash ~/.claude/hooks/sweetclaude/record-event.sh skill_invoked "sweetclaude:big-picture"`

# Big Picture

This skill has been absorbed into `/sweetclaude:status roadmap`.

Invoke the status skill with the `roadmap` argument now:
