...
user-invocable: true
description: "Use when hibernating or unhibernating a project managed by SweetClaude."
---


!`bash ${CLAUDE_SKILL_DIR}/../../scripts/record-event.sh skill_invoked "skill=sweetclaude:hibernate"`
