...
user-invocable: true
description: "Design the data model: entities, relationships, constraints, indexes, and migration strategy."
category: technical
---


!`bash ${CLAUDE_SKILL_DIR}/../../scripts/record-event.sh skill_invoked "skill=sweetclaude:design-data-model"`
