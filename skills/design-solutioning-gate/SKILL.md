...
description: "Validate the proposed solution before implementation."
---


!`bash ${CLAUDE_SKILL_DIR}/../../scripts/record-event.sh skill_invoked "skill=sweetclaude:design-solutioning-gate"`
