...
user-invocable: true
description: "Manage deferred work."
category: product
---


!`bash ${CLAUDE_SKILL_DIR}/../../scripts/record-event.sh skill_invoked "skill=sweetclaude:product-parking-lot"`
...
**Dependency check:**
Read `${CLAUDE_PLUGIN_ROOT}/config/skills-registry.yaml`. Find `skills.product-parking-lot.dependencies`. This skill has no dependencies — skip.
