...
user-invocable: true
description: "Manage roadmap targets (milestones) that span strategy and product work."
category: product
---


!`bash ${CLAUDE_SKILL_DIR}/../../scripts/record-event.sh skill_invoked "skill=sweetclaude:product-milestones"`
