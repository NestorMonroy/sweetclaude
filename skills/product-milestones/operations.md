# Milestones Operations — sub-skill content

**Sections:**
- [pause](#pause--temporarily-stop-using-this-skill)
- [offboard](#offboard--export-data-and-stop-using-this-skill)
- [Lightweight first-invocation](#lightweight-first-invocation--quick-setup-on-first-use)
- [onboard](#onboard--first-time-setup)
- [add](#add--create-a-new-milestone)
- [review](#review--list-milestones-by-commitment-level)
- [link](#link-work-item-ms-xxx--bidirectional-attach)
- [status](#status-ms-xxx--detail-view)
- [blockers](#blockers-ms-xxx--what-is-stopping-us)
- [complete](#complete-ms-xxx--mark-achieved-and-chain-follow-ups)
- [unassigned](#unassigned--hygiene-check)
